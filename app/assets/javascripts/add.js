$(function() {
  if($('body').is('.addclass')) {
  	var myCourses = gon.myCourses;
  	var dict = gon.dict;

  	var stateObject = dict;
    var stateSel = document.getElementById("stateSel"), countySel = document.getElementById("countySel"), citySel = document.getElementById("citySel");
